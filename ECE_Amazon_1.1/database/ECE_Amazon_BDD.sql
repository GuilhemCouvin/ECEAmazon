...
CREATE TABLE IF NOT EXISTS `produit` (
  ...
  `quantité_totale` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produit_stock` (
  ...
  `categorie` varchar(50) NOT NULL,
  `taille` varchar(50) NOT NULL,
  `quantité_restante` varchar(50) NOT NULL,
  `description` varchar(50) NOT NULL,
  `genre` varchar(50) NOT NULL,
  `photo` varchar(50) NOT NULL DEFAULT 'ece.jpg',
  `trn_date` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produit_vendu` (
  ...
  `categorie` varchar(50) NOT NULL,
  `taille` varchar(50) NOT NULL,
  `quantité_vendue` varchar(50) NOT NULL,
  `description` varchar(50) NOT NULL,
  `genre` varchar(50) NOT NULL,
  `photo` varchar(50) NOT NULL DEFAULT 'ece.jpg',
  `trn_date` datetime NOT NULL,
...
(1, 'GuilhemC', 'guilhemc75@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Couvin', 'Guilhem', '361 RUE DE VAUGIRARD', '', '', '2019-04-29 12:07:52');
...
INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(8, 'Tshirt blanc', '24,99', '1', 'Vetements','M', '3', 'tshirt 100% coton made in Népal', 'Homme', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(1, 'Tshirt rouge', '24,99', '1', 'Vetements','S', '3', 'tshirt 100% coton made in Népal', 'Femme', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(2, 'Game of Thrones Tome 1', '9,99', '2', 'Livres','', '5', 'Livre Game of Trones Tome 1 format Poche', '', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(3, 'Game of Thrones Tome 2', '9,99', '2', 'Livres','', '5', 'Livre Game of Trones Tome 2 format Poche', '', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(4, 'Ballon de foot', '4,99', '3', 'Sports&Loisirs','', '10', 'Ballon de foot rouge en cuir', '', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(5, 'Balles de Tennis', '2,99', '3', 'Sports&Loisirs','', '10', 'Balles de Tennis', '', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(6, 'Album Daft Punk - Discovery', '7,99', '2', 'Musique','', '15', 'Album de musique électronique Daft Punk', '', '', '2019-04-29 12:07:52');

INSERT INTO `produit` (`id`, `name`, `price`, `id_vendeur`, `categorie`, `taille`, `quantité_totale`, `description`, `genre`, `photo`,`trn_date`) VALUES
(7, 'Album PNL - Deux Frères', '7,99', '2', 'Musique','', '15', 'Album musique Hip-Hop', '', '', '2019-04-29 12:07:52');
COMMIT;
